...
var liElements = document.querySelectorAll("ul li"); // Select all <li> elements within <ul> elements, adjust the selector as needed

liElements.forEach(function(liElement) {
if (liElement.textContent === 'null null' && liElement.textContent === 'null') {
